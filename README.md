...
| `/telegram link` | Привязать Telegram | bugreports.telegram |
| `/telegram unlink` | Отвязать Telegram | bugreports.telegram |
| `/telegram status` | Проверить статус привязки | bugreports.telegram |
...
- `bugreports.telegram` - Доступ к Telegram интеграции (по умолчанию: op)
