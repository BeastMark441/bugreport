...
### Версия 1.1.1
- 🐛 Исправлены ошибки:
  - Исправлена проблема с двойными уведомлениями в Telegram
  - Исправлена проблема с загрузкой messages.yml
  - Исправлено отображение даты создания репорта в Telegram
  - Исправлено форматирование сообщений от администраторов
  - Добавлена корректная обработка уведомлений для оффлайн игроков
  - Добавлена поддержка Minecraft 1.16.5
- ✨ Улучшения:
  - Добавлена система уведомлений для сообщений от администраторов в игре
  - Улучшена обработка текстовых компонентов в чате
  - Оптимизирована работа с базой данных при получении последнего репорта
